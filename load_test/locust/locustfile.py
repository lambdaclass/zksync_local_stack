...
create_erc20_wallets_with_money(node_host, True, wallets_with_money, rich_wallets[0],
                                erc20_contract_address) # we are always deploying a new contract. so we always need to transfer
