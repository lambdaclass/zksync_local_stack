...
run:
	...
	tmux send-keys -t zksync-witness-generator "cd ${ZKSYNC_HOME}/prover" Enter; \
	...
	tmux send-keys -t zksync-prover "cd ${ZKSYNC_HOME}/prover" Enter; \
	...
	tmux send-keys -t zksync-proof-compressor "cd ${ZKSYNC_HOME}/prover" Enter; \
	...
	tmux send-keys -t zksync-prover-gateway "cd ${ZKSYNC_HOME}/prover" Enter; \
